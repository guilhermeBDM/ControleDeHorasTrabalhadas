...
namespace NSF.TCC.Sundown.Business
{
    public class LoginDataBase
    {
        ...
        {
            string query = "select tb_usuario.id_usuario, tb_usuario.nm_nome,tb_usuario.ds_email,tb_usuario.ds_senha from tb_usuario  WHERE ds_email = @ds_email AND ds_senha = @ds_senha";
